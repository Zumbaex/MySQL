...
CREATE TABLE user_news (
    ...
    FOREIGN KEY (friends_id) REFERENCES friends_list(id) ON UPDATE CASCADE ON DELETE SET NULL
    FOREIGN KEY (post_id) REFERENCES user_post(id) ON UPDATE CASCADE ON DELETE CASCADE
);